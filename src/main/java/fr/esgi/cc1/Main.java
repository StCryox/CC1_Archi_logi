...
import fr.esgi.cc1.membership.domain.MembershipService;
...
public class Main {
    public static void main(String[] args) {
        ...
        MembershipService membershipService = new MembershipService(tradesmanApplicationService, paymentProcessService);
        ...
        membershipService.Subscribe(createTradesman, createPayment);
    }
}
